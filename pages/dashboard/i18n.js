...
(() => {
  ...
  const MSG = {
    ...
    "nav.trace":          { zh: "组装追踪", en: "Assembly Trace", ru: "Трассировка" },
    ...
    /* ---- Trace ---- */
    "trace.title":              { zh: "Context 组装追踪", en: "Context Assembly Trace", ru: "Трассировка сборки контекста" },
    "trace.totalTraces":        { zh: "总追踪数", en: "Total Traces", ru: "Всего трасс" },
    "trace.uniqueSessions":     { zh: "独立会话", en: "Unique Sessions", ru: "Уникальных сессий" },
    "trace.avgInjected":        { zh: "平均注入数", en: "Avg Injected", ru: "Средн. инъекций" },
    "trace.maxInjected":        { zh: "最大注入数", en: "Max Injected", ru: "Макс. инъекций" },
    "trace.skippedCount":       { zh: "跳过次数", en: "Skipped", ru: "Пропущено" },
    "trace.noTraces":           { zh: "暂无追踪记录", en: "No traces yet", ru: "Трасс нет" },
    "trace.skipped":            { zh: "跳过", en: "Skipped", ru: "Пропуск" },
    "trace.injected":           { zh: "注入", en: "injected", ru: "инж." },
    "trace.summary":            { zh: "摘要", en: "Summary", ru: "Сводка" },
    "trace.atoms":              { zh: "原子", en: "atoms", ru: "атом." },
    "trace.sectionBasic":       { zh: "基本信息", en: "Basic Info", ru: "Базовая инфо" },
    "trace.sectionRouting":     { zh: "路由权重", en: "Route Weights", ru: "Веса маршрутов" },
    "trace.sectionMerged":      { zh: "融合结果", en: "Merged Results", ru: "Объединённые результаты" },
    "trace.sectionEmotion":     { zh: "情感路由", en: "Emotion Routing", ru: "Эмоциональный маршрут" },
    "trace.sectionRecency":     { zh: "活跃窗口", en: "Recency Boost", ru: "Свежесть" },
    "trace.sectionSummary":     { zh: "会话摘要", en: "Session Summary", ru: "Сводка сессии" },
    "trace.sectionInjection":   { zh: "注入文本", en: "Injected Text", ru: "Внедрённый текст" },
    "trace.sectionReflection":  { zh: "自省", en: "Self-Reflection", ru: "Саморефлексия" },
    "trace.sectionErrors":      { zh: "错误", en: "Errors", ru: "Ошибки" },
    "trace.sessionId":          { zh: "会话 ID", en: "Session ID", ru: "ID сессии" },
    "trace.queryIntent":        { zh: "查询意图", en: "Query Intent", ru: "Намерение" },
    "trace.emotion":            { zh: "情感", en: "Emotion", ru: "Эмоция" },
    "trace.contextExpanded":    { zh: "扩展计数", en: "Context Expanded", ru: "Расширение" },
    "trace.injectionMethod":    { zh: "注入方式", en: "Injection Method", ru: "Метод внедрения" },
    "trace.fallbackReason":     { zh: "降级原因", en: "Fallback Reason", ru: "Причина отката" },
    "trace.estTokens":          { zh: "预估 Token", en: "Est. Tokens", ru: "Токены (оценка)" },
    "trace.expandedQuery":      { zh: "扩展查询", en: "Expanded Query", ru: "Расширенный запрос" },
    "trace.docRoute":           { zh: "文档路由", en: "Document", ru: "Документ" },
    "trace.graphRoute":         { zh: "图谱路由", en: "Graph", ru: "Граф" },
    "trace.results":            { zh: "条", en: "results", ru: "рез." },
    "trace.emotionDesc":        { zh: "有 {0} 条记忆受到情感加权提升", en: "{0} memories received emotion boost", ru: "{0} памятей получили эмоц. буст" },
    "trace.recencyDesc":        { zh: "有 {0} 条记忆受到活跃窗口加权", en: "{0} memories received recency boost", ru: "{0} памятей получили буст свежести" },
    "trace.skipReason":         { zh: "跳过原因", en: "Skip Reason", ru: "Причина пропуска" },
