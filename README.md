...
- **Three-Tier Memory Architecture (L1/L2/L3)**: Inspired by DeepTutor. L1 = raw messages, L2 = session facts, L3 = cross-session synthesized insights. Full provenance trace chain.
